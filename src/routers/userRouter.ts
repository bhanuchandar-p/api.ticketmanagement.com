...
import { canCreateDeveloperUser, canCreateRegularUser, canViewAllUsers, canViewUser } from '../middlewares/guards/guardUser';
...
userRouter.get('/:id',canViewUser,userController.getUserbyId);
